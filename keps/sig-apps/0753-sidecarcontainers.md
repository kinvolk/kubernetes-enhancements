...
- [Alternatives](#alternatives)
  - [pod.SidecarContainers](#podsidecarcontainers)
  - [Primary Container](#primary-container)
  - [Sidecar: true](#sidecar-true)
  - [terminationFatalToPod: true](#terminationfataltopod-true)
  - [Depends On](#depends-on)
  - [Startup/Shutdown Phases/Numbers](#startupshutdown-phasesnumbers)
<!-- /toc -->
...
container is a sidecar container.

Pods with sidecar containers only change the behavior of startup and shutdown
sequence of a pod: sidecar container are started before non-sidecars and stopped
after non-sidecars.
...
### Startup/Shutdown Phases/Numbers
